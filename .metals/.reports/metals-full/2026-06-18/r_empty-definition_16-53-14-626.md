error id: file:///C:/Users/USER/Downloads/Kaizer-Back-main/Kaizer-Back-main/src/main/java/com/example/Kaizer_Back/checkout/CheckoutService.java:java/math/BigDecimal#subtract().
...
empty definition using pc, found symbol in pc: java/math/BigDecimal#subtract().
...
public CheckoutResponse checkout(CheckoutRequest request) {
    ...
    BigDecimal igv = totalProductos.su@@btract(baseImponible);
